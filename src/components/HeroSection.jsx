...
const HeroSection = () => {
  ...
  const pizzaImg = "https://res.cloudinary.com/ddfimjibr/image/upload/v1747961831/pizzahut_images/tvt3gwlxmqtrrqk8epvd.png"
  const leafImg = "https://res.cloudinary.com/ddfimjibr/image/upload/v1747961819/pizzahut_images/zxkx0dxhrzjit11km9i6.png"
const pizzaSliceImg = "https://res.cloudinary.com/ddfimjibr/image/upload/v1747961830/pizzahut_images/sufj1lb8w5tamux5qohi.png"
const leafsImg = "https://res.cloudinary.com/ddfimjibr/image/upload/v1747961876/pizzahut_images/jstaefabqh3atullyvwm.png"
      ...
      <div className=' w-[90vw] md:w-[80vw] max-w-6xl mx-auto '>
        ...
        <div className='relative flex flex-col sm:grid sm:grid-cols-2 mt-8'>
          ...
          <div className='hidden sm:block'>
            <img width={150} height={150} className='absolute xl:left-[38rem] left-[16rem] -top-[5rem] overflow-hidden' src={leafsImg} alt="" />
